...
#To delete message of a user in a room and make changes to the database:
@login_required(login_url="login")
...
def topicsPage(request):
    q=request.GET.get('q') if request.GET.get('q') != None else "" 
    topics=Topic.objects.filter(name__icontains=q) # filter() without args will act as all()
