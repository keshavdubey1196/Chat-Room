This app is built using Django (Python) Technology. In this app we can create rooms, users can message in the room, users can create room of their preference:
